...
public class DefaultProxyConfig implements ProxyConfig, InitializingBean {
	...
	/**
	 * @see ProxyConfig#getProxiedInterfaces()
	 */
	...
	/**
	 * @see ProxyConfig#getAttributeRegistry()
	 */
	...
	/**
	 * @see ProxyConfig#addMethodPointcut(int, MethodPointcut)
	 */
	...
	/**
	 * @see ProxyConfig#addMethodPointcut(MethodPointcut)
	 */
